...
<body>
    ...
    <div class="borders-intro">
        <h1>Discover your next great read here at Bibliooo<span class="reg">®</span></h1>   
    <div class="borders-fom">
        <h6><a href="index.php?p=register">find out more by registering with us!</a></h6>
        <br>
        <br>
        <br>
    <div class="bseller main">
        ...
        <div class="entry-meta">
			<span class="entry-date">Our specialty books are all yours to take!</span> 
					</div><!-- .entry-meta -->
        <br>
        <br>
